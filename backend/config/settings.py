...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://127.0.0.1:3000',
    'http://localhost:8000',
    'https://eventpng.onrender.com',  # Remove trailing slash
]
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'https://da12311f7ddc.ngrok-free.app',
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@eventpng.com')

# For development - print emails to console
if DEBUG:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
else:
    # Production email settings (example using Gmail SMTP)
...
MIDDLEWARE = [
    ...
    'config.middleware.DisableCSRF',  # Disable CSRF for development
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',  # Keep this for admin
