...
# -----------------------------------------------------------------------------
if DEBUG:
    # In development, log emails to console and database
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'  # Or use 'django.core.mail.backends.console.EmailBackend' for console output
    
    # Log all emails to the database
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    
    # Add email logging configuration
    LOGGING = {
        'version': 1,
